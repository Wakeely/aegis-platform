...
import { Shield, Check, ArrowRight, Mail, Lock, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="auth-form-panel">
        <div className="auth-form-container">
          ...
          <div className="auth-toggle">
            <button className="auth-toggle-btn active">Sign In</button>
            <Link to="/signup" className="auth-toggle-btn inactive">Create Account</Link>
          </div>
